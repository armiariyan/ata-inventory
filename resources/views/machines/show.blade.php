            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <img src="{{ asset('storage') }}/{{ $machine->photo }}" alt="" srcset="" style="max-width: 1000px">               
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label  class="col-sm-1 col-form-label  fw-bold text-end">Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" disabled value="{{ $machine->name }}">               
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label  class="col-sm-1 col-form-label  fw-bold text-end">Type</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" disabled value="{{ $machine->type }}">               
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label  class="col-sm-1 col-form-label  fw-bold text-end">Notes</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" placeholder="{{ $machine->notes }}" disabled></textarea>     
                        </div>
                    </div>
                </div>
            </div>
